  ...
  return (
    <div className="flex-grow w-full h-full overflow-hidden relative flex flex-row p-2 gap-2 bg-surface-container-lowest">
      ...
      <div className="w-[50%] h-full relative flex flex-col items-center justify-start p-2">
        ...
        {/* Wrapper to bound the Decagon strictly to its parent height. Added -mt-28 to move it higher. */}
        <div className="w-full h-full max-h-full flex items-start justify-center overflow-hidden -mt-28">
          <Decagon schedules={schedules} activeSlot={activeSlot} onSlotClick={handleSlotClick} />
        </div>
      </div>

      {/* RIGHT COLUMN: Huge Next Dose */}
      {/* Added pr-10 and pb-56 to add padding to the right and bottom */}
      <div className="w-[50%] h-full flex flex-col gap-2 p-2 pr-10 pb-56">
      ...
      {isDispensing && (
        <div className="absolute inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4 animate-in fade-in duration-200">
           <div className="bg-surface-container-lowest w-[90%] max-w-[600px] h-[90%] rounded-2xl border-4 border-error shadow-2xl flex flex-row overflow-hidden">
             ...
             {/* Match pb-56 padding */}
             <div className="w-[60%] bg-error-container text-on-error-container flex flex-col items-center justify-center p-4 pb-56 text-center">
             ...
             {/* Match pb-56 padding */}
             <div className="w-[40%] flex items-center justify-center bg-tertiary-container p-4 pb-56">
               <button 
